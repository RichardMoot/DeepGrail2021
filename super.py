...
from keras.layers import Embedding, Bidirectional, Dense, Input, Dropout, LSTM, Activation, TimeDistributed, BatchNormalization, concatenate, Concatenate
...
# change this directory to where you have installed DeepGrail (these files)
# this directory change ensure Python won't accidentally loads another
# model if one exists in the current directory.

current_dir = os.getcwd()
os.chdir('/Users/moot/checkout/DeepGrail/deepgrail')   
...
# Replace this line by the path to elmoformanylangs and its French model
# from
#
# https://github.com/HIT-SCIR/ELMoForManyLangs?tab=readme-ov-file
